...
<style scoped>
.knowledge-details{background:var(--paper);border:1px solid var(--line);border-radius:10px;padding:20px;min-width:0;color:#263950;font-size:13px;overflow:auto;max-height:780px;box-sizing:border-box}.kind-tag{display:inline-block;padding:5px 9px;border-radius:5px;background:var(--blue-soft);color:#3566a8;font-size:12px}h3{font-size:20px;margin:12px 0 8px;overflow-wrap:anywhere}.resource-id{font-size:12px;color:var(--muted);overflow-wrap:anywhere}.definition{line-height:1.85;white-space:pre-wrap}.explanation{background:var(--paper-2);border-left:3px solid #89aad6;padding:12px;color:#58718f;font-size:12px;line-height:1.7}.maintain{padding:9px 12px;border:1px solid var(--blue-line);border-radius:6px;background:var(--blue-soft);color:#2c64b1;cursor:pointer}h4{font-size:13px;margin:22px 0 10px;border-top:1px solid var(--paper-3);padding-top:16px}.source code{display:block;font-size:12px;overflow-wrap:anywhere;color:var(--muted)}.source p,.muted{font-size:12px;color:var(--muted);line-height:1.7}.fields{margin:20px 0}.fields dt{color:var(--muted);margin:16px 0 5px;font-size:12px}.fields dd{margin:0;white-space:pre-wrap;overflow-wrap:anywhere;line-height:1.8}.edge-path{display:flex;flex-direction:column;align-items:stretch;gap:9px;margin:15px 0}.edge-path span{text-align:center;color:var(--faint)}.edge-path button{padding:9px;border:1px solid var(--line);background:var(--paper-2);border-radius:5px;color:#315f9d;cursor:pointer}.related{display:flex;flex-direction:column;gap:6px;width:100%;text-align:left;background:var(--paper-2);border:1px solid var(--line);border-radius:6px;padding:11px;margin:8px 0;color:#587394;font-size:12px;cursor:pointer}.related strong{color:#2e5b96;overflow-wrap:anywhere}.relation-type{color:var(--faint);font-size:12px}.property-row{display:flex;justify-content:space-between;align-items:start;gap:10px;border-bottom:1px solid var(--paper-3);padding:9px 0;font-size:12px}.property-row span{color:var(--faint);overflow-wrap:anywhere}.property-row button{border:0;background:none;color:#2e67b1;padding:0;text-align:left;cursor:pointer}.raw{margin-top:22px;font-size:12px;color:var(--muted)}.raw summary{cursor:pointer}.raw pre{white-space:pre-wrap;overflow-wrap:anywhere;background:var(--paper-2);border-radius:5px;padding:12px;line-height:1.65;max-height:330px;overflow:auto}.no-selection{padding:40px 0;color:var(--faint);line-height:1.85}.no-selection h3{color:#425d7e;font-size:17px}.empty-icon{font-size:32px;color:#a0b5d0}button:focus-visible,summary:focus-visible{outline:2px solid #3478d6;outline-offset:3px}
</style>
