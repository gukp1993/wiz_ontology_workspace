...
<style scoped>
.knowledge-explorer{display:grid;gap:14px}.ke-head{display:flex;align-items:center;justify-content:space-between;gap:20px}.ke-head h2{margin:0 0 8px;font-size:20px}.ke-head p,.ke-legend{margin:0;color:var(--muted);font-size:13px;line-height:1.7}.ke-presets{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.ke-presets button{text-align:left;padding:13px 16px;background:var(--paper);border:1px solid var(--line);border-radius:var(--r-md)}.ke-presets button.active{border-color:var(--blue);background:var(--blue-soft);box-shadow:inset 0 0 0 1px var(--blue);color:var(--blue-ink)}.ke-presets strong,.ke-presets small{display:block}.ke-presets strong{font-size:15px;margin-bottom:5px}.ke-presets small{font-size:12px;color:var(--muted)}.ke-options{display:flex;gap:14px;flex-wrap:wrap;background:var(--paper);padding:12px;border:1px solid var(--line);border-radius:var(--r-md)}.ke-options label,.ke-search label{display:flex;gap:6px;align-items:center;font-size:13px;white-space:nowrap;margin:0}.ke-options small{color:var(--muted)}.ke-options input,.ke-search input[type=checkbox]{width:auto;margin:0;accent-color:var(--blue)}.ke-search{display:flex;gap:12px;align-items:center;flex-wrap:wrap}.ke-search>input{max-width:420px;flex:1;min-width:220px;margin:0}.ke-search>:deep(.app-select){width:260px;max-width:100%;flex:0 1 260px}.ke-search span{font-size:12px;color:var(--muted);margin-left:auto}.ke-workspace{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:14px;align-items:start}.ke-workspace.expanded{grid-template-columns:1fr}.ke-project{font-size:13px;margin:0;background:var(--blue-soft);padding:10px;border-radius:var(--r-sm)}.ke-warnings{background:var(--warn-soft);border:1px solid var(--warn-line);border-radius:var(--r-sm);padding:10px;font-size:13px}.ke-warnings summary{cursor:pointer}.ke-warnings ul{max-height:220px;overflow:auto;padding-left:20px;line-height:1.8}@media(max-width:1100px){.ke-workspace{grid-template-columns:1fr}.ke-presets small{line-height:1.5}}@media(max-width:650px){.ke-presets{grid-template-columns:1fr}.ke-head{align-items:flex-start;flex-direction:column}}
</style>
